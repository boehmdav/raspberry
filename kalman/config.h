 ...
 * ******************************/
#define SE_FAKE_MODE		SIN		// Art der gefälschten Messwerte (CONST für konstant, LIN für lineare Werte, RAND für zufällige Werte, SIN für Sinusschwingungen, DATA zum Einlesen alter Logs)
