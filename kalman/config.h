 ...
 * ******************************/
#define SENSOR_MODE		REAL_VAL	// Aktiviert echte Sensorwerte (REAL_VAL) oder gefäschte Sensorwerte (FAKE)
...
#define MIN_DISTANCE		20		// Kleinster möglicher Messwert
#define SE_MIN_DISTANCE		40		// Kleinster glaubhafter Sensormesswert
#define SE_MIN 			MIN_DISTANCE	// Kleinster Messwert
...
#define CONST_HEIGHT		80

/********************************
 * Einstellungen zur Erzeugung gefälschter Sensorwerte
 * Nur aktiv, wenn SENSOR_MODE auf FAKE gesetzt ist
 * ******************************/
#define SE_FAKE_MODE		DATA		// Art der gefälschten Messwerte (CONST für konstant, LIN für lineare Werte, RAND für zufällige Werte, SIN für Sinusschwingungen, DATA zum Einlesen alter Logs)
#define SE_FAKE_MODE_START_VAL	50		// Startwert der gefälschten Messwerte

#define SE_FAKE_MODE_LIN_CHANGE_PROB	1	// Wahrscheinlichkeit in Prozent, dass der Anstieg die Richtung wechselt
#define SE_FAKE_MODE_LIN_INC		1	// Anstieg der linearen Messwerte

#define SE_FAKE_MODE_DATA_IN		"log/122/"	// Ordner, aus dem ältere Messwerte gelesen werden

#define SE_FAKE_MODE_NOISE_PROB		10	// Wahrscheinlichkeit, dass ein Messwert gestört wird
#define SE_FAKE_MODE_NOISE_STRENGTH	100	// Maximale Stärke der Störung

/********************************
 * Filter-Einstellungen
 * ******************************/
#define SE_DATA_BUFFER_SIZE	1		// Groesze des Messwertebuffers
						// 1 schaltet den Filter aus, 2 ermittelt Mittelwert zwischen den letzten beiden Messungen, >2 normales Filterverhalten
#define FILTER_MODE		KALMAN		// Filtermodus (MEDIAN, MEAN oder KALMAN)

#define SE_CORRECTION		0b10		// Bitmaske zum an- und ausschalten von Korrekturen (2⁰: Nahbereichskorrektur, 2¹: Winkelkorrektur)
...
#define VARIANCE_B		0/*0.008f*/		// Varianz der Barometer-Daten für den Kalman-Filter
...
#define MAX_THRUST		610
#define MIN_THRUST		520
 ...
 * ******************************/
#define IMAX			500
#define THRUST_IMAX		500

#define THRUST_KP		0.399779f
#define THRUST_TN		0.0148838f
#define THRUST_TV		0.306536f
